...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void bt_start_Click(object sender, EventArgs e)
        {
            ...
            Type contractType = typeof(WcfServiceLibrary.IServiceLibrary);
            Type instanceType = typeof(WcfServiceLibrary.ServiceLibrary);
            ...
            ComboBox[] cmb = new ComboBox[3] { cb_1, cb_2, cb_3 };
                ...
                string relativeAddress = "ServiceLibrary";
                for (int i = 0; i < 3; i++)
                {
                    if (chb[i].Checked == true)
                    {
                        ...
                        {
                            string relativeAddress1 = "ServiceLibrary1";
